...
Below is the basic map of incidents - using the github default map display: 

<script src="https://embed.github.com/view/geojson/fozy81/nuclear-ghost/master/ndata.geojson"></script>
